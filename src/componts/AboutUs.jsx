...
function AboutUs() {
  return (
    <section
      id="About"
      dir="rtl"
      className="relative top-[50vh] mx-auto w-full max-w-[1000px] p-5 bg-gradient-to-r from-[#ffffff] to-[#f9f9f9] rounded-[15px]  text-center mb-10"
    ...
    >
      <div className="about-us-content">
        ...
        <p className="text-[1.2rem] text-[#333] leading-[1.8] mb-5">
          شركة مختصة بتصليح أجزاء السيارات والسيارات بشكل عام.
          <br />
          خدماتنا شاملة تشمل جميع أجزاء المركبة.
          <br />
          بدأت قصتنا في ورشة صغيرة لتصليح السيارات سنة 2010.
          <br />
          ومع مرور الوقت إلى يومنا هذا سنة 2024 أصبح لدينا 6 أفرع في بغداد فقط:
        </p>
        <ul className="list-none p-0 mb-5">
          <li className="text-[1.2rem] font-semibold text-[#555] mb-2">
            فرع الكرادة
          </li>
          <li className="text-[1.2rem] font-semibold text-[#555] mb-2">
            فرع الأعظمية
        ...
        <p className="text-[1.2rem] text-[#333] leading-[1.8]">
          كارفكس تحوي على أمهر العاملين أصحاب خبرة لسنوات طويلة في مجالنا.
          سيارتك بيد أمينة.
        </p>
      </div>
    </section>
